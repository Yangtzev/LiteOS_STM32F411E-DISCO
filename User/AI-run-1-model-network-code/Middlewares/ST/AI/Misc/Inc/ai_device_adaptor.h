...
#if !defined(SR6X)
#include "..\..\..\..\..\..\..\LiteOS\arch\arm\common\cmsis\cmsis_compiler.h"
#endif
...
/* Use the project-level retarget implementation from bsp_debug_usart.c
   to avoid duplicate fputc definitions with aiTestUtility.c. */
#define USE_RETARGET_IO_FROM_TOOL         1
