...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x30589a26beb71cf9e270fa36b98c9b67"
#define _STAI_NETWORK_DATETIME            "2026-04-24T16:16:56+0800"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 12256),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
void forward_lite_mp_max_pooling2d(_stai_network_context* net_ctx)
{
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(3, 1, { activation_output.data->data});
  forward_mp(&max_pooling2d_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(3, 1, { max_pooling2d_output.data->data});
}
  ...
  const stai_run_mode mode)
{
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(1, 1, {(stai_ptr) conv2d_t_in_0_ptr_const_f32});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(1, 1, {(stai_ptr) conv2d_t_out_0_ptr_f32});
  }
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(2, 1, {(stai_ptr) activation_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(2, 1, {(stai_ptr) activation_t_out_0_ptr_handle});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN dense */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 352),
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(5, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 352)});
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_1_dense */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 12048),
      .bias = (float*)(net_ctx->_weights[0] + 12240),
      .n_channel_in = 12,
      .n_channel_out = 4,
      .n_elements = 1,
    };
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(7, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 48)});
  }
